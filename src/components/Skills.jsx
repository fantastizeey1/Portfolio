...
function Skills() {
  ...
  return (
    <div id='Skills' className='bg-gradient-to-br from-gray-600 to-black w-full m-auto md:pl-20 p-4 py-16 text-white'>
            ...
            <div className='w-full grid lg:grid-cols-3 grid-cols-2 gap-8 lg:gap-16 text-center py-8 px-12 sm:px-0 '>

                {
                    skills.map(({id, src, title, style}) => (
                        <div key={id} className={`shadow-md hover:scale-105 border-gray-6 text-white
                         duration-500 py-2 rounded-lg ${style}`}>
                        <img src={src} 
                        className='w-20 h-[60%] mx-auto'
                        alt="Html_logo"  
                        />
